...
const Certifications = () => {
  const certifications = [
  {
      ...
      date: "2025",
      status: "Active",
      credentialId: "5116235b-d050-4e2b-85dc-2b12dc88af35",
    ...
    },
    {
      ...
      date: "2025",
      status: "Active",
      credentialId: "dc6bcb4f-37ba-4970-8864-aa1de54ea37b",
    ...
    },
    {
      ...
      date: "2025",
      status: "Active",
      credentialId: "792146f6-15b1-4c0c-85ce-1104c242c6aa",
      description: "Completed Data Science Essentials with Python, demonstrating skills in data analysis, visualization, and modeling using Python, along with strong analytical thinking and communication of insights.",
      skills: ["Python(Pandas and Matplotlib)", "Jupyter Notebook", "Exploratory Data Analysis", "Storytelling With Data"],
      icon: "📊",
      verifyLink: "https://www.credly.com/badges/792146f6-15b1-4c0c-85ce-1104c242c6aa/public_url",
      category: "Data Analytics"
    },
    {
  title: "AWS AI Practitioner",
  issuer: "Udacity (AWS AI/ML Scholarship)",
  date: "2025",
  status: "Completed",
  credentialId: "2ac74a2c-31a5-11f1-99c2-8f49a9c2198b",
  description: "Udacity certifies that the earner successfully completed the AWS AI Practitioner program, gaining foundational knowledge in Artificial Intelligence, Machine Learning concepts, AWS AI services, and real-world AI applications.",
  skills: ["Artificial Intelligence", "Machine Learning", "AWS AI Services", "Data Fundamentals"],
  icon: "🤖",
  verifyLink: "https://www.udacity.com/certificate/e/2ac74a2c-31a5-11f1-99c2-8f49a9c2198b",
